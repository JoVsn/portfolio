...
class Main extends Component {
    ...
    componentDidMount() {
        ...
        let clouds = document.getElementById('japanese-clouds');
        console.log(clouds);
        TweenMax.to(clouds, 2, { y: 50, repeat: -1, yoyo: true });
            ...
            <ul className="side-content-container-list">
              ...
              <li className="side-content-container-list-item">Graphism</li>
                ...
                <div className="content-background">
                    <img src={japaclouds_img} alt="Japanese clouds" id="japanese-clouds" />
                </div>
